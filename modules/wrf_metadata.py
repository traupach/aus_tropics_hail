...
def analyse_wrfinput(wrfinput_file):
    ...
    print(
        'Min, mean, max vertical dist. between mass pts:\t'
...
def wrf_ra_lw_scheme(wrfin):
    ...
    """
    schemes = {1: 'RRTM', 3: 'CAM', 4: 'RRTMG', 24: 'RRTMG fast', 14: 'RRTMG-K', 5: 'New Goddard', 7: 'FLG', 31: 'Held-Suarez', 99: 'GFDL'}
...
def wrf_ra_sw_scheme(wrfin):
    ...
    """
    schemes = {1: 'Dudhia', 2: 'Goddard', 3: 'CAM', 4: 'RRTMG', 24: 'RRTMG', 14: 'RRTMG-K', 5: 'New Goddard', 7: 'FLG', 99: 'GFDL'}
